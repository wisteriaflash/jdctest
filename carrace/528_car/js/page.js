...
function getGap(currentMiles){
    ...
    var arr = [{miles:81341,award:100},{miles:123874,award:300},{miles:277747,award:1600},{miles:411506,award:4666},{miles:500457,award:null}];
...
function shareFunction(){
    s_oRequestManager.sendRealRequest("theCarRaceWeiXinShareOil", g_sid, " ", function (json) {
        ...
        var param = [encodeURIComponent("4666元加油卡就要到手，快来帮我加油！"),encodeURIComponent(content+"，东南DX7豪送的4666元加油卡就要到手!"),shareURL,"http://h5.m.jd.com/active/carrace/sprites/icon.jpg"];
