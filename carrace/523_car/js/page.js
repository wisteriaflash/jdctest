...
function shareFunction(){
    s_oRequestManager.sendRealRequest("theCarRaceWeiXinShareOil", g_sid, " ", function (json) {
        ...
        var param = [encodeURIComponent("4666元加油卡就要到手，快来帮我加油！"),encodeURIComponent("加急 加急！帮我加把油，东风标致豪送的4666元的加油卡就要到手!"),shareURL,"http://h5.m.jd.com/active/carrace/sprites/icon.jpg"];
