...
function CGame() {
    ...
    p = 0,
    g_life, q, v = 0,
    B, x, s = [], n, r, button1, button2, button3, w, t, u, C, D, _helpPic, E, _leftBottom, _rightBottom, _guideTop, _roadTop;//,
	//gameContainer;
    ...
    this._init = function() {
		...
		*/
		...
		//a = s_oSpriteLibrary.getSprite("logo_top");
		//logoTop = new createjs.Bitmap(a);
		//logoTop.regX = a.width / 2;
		//logoTop.regY = a.height / 2;
		//logoTop.x = CANVAS_WIDTH * .5;
		//logoTop.y = CANVAS_HEIGHT * .1;
		//logoTop.scaleX = logoTop.scaleY = CANVAS_WIDTH * .3 / logoTop.getBounds().width;
		//s_oStage.addChild(logoTop);
...
function CMain() {
   ...
   //          })),
    ...
    this._loadImages = function() {
        ...
        s_oSpriteLibrary.addSprite("logo_top", "./sprites/game_logo_top.png");
        s_oSpriteLibrary.addSprite("logo_left", "./sprites/game_logo_top.png");
        s_oSpriteLibrary.addSprite("logo_right", "./sprites/game_logo_bottom_right.png");
...
function CHelpPanel(a) {
    ...
    this._init = function(a) {
		...
		a = s_oSpriteLibrary.getSprite("logo_left");
		logoLeft = new createjs.Bitmap(a);
		logoLeft.regX = a.width / 2;
		logoLeft.regY = a.height/2;
		logoLeft.x = CANVAS_WIDTH * .15;
		logoLeft.y = CANVAS_HEIGHT * .1 - 30;
		logoLeft.scaleX = logoLeft.scaleY = CANVAS_WIDTH * .25 / logoLeft.getBounds().width;
		
		a = s_oSpriteLibrary.getSprite("logo_right");
		logoRight = new createjs.Bitmap(a);
		logoRight.regX = a.width / 2;
		logoRight.regY = a.height/2;
		logoRight.x = CANVAS_WIDTH * .85;
		logoRight.y = CANVAS_HEIGHT * .1 - 30;
		logoRight.scaleX = logoRight.scaleY = CANVAS_WIDTH * .1 / logoRight.getBounds().width;
		...
		*/
		...
		h.addChild(d , e, logoLeft, logoRight);
        s_oStage.addChild(h);
