...
function pageInitScreen()
{
    ...
    TweenMax.to($("#button_prize"),0, { top: window.innerHeight / heightRatio - 176 - 474 });
...
function gameStart() {
    ...
    s_oRequestManager.sendRealRequest("theCarRaceInitExecute", g_sid, 'body={"date": "'+getTodayDate()+'"}', function (json) {
        ...
        //else
        //{
        //window.open("prize.html",'newWin','scrollbars=no');
...
function shareFunction(){
    s_oRequestManager.sendRealRequest("theCarRaceWeiXinShareOil", g_sid, " ", function (json) {
        ...
        var param = [encodeURIComponent("4666元加油卡就要到手，快来帮我加油！"),encodeURIComponent(content+"，一汽-大众宝来 豪送的4666元加油卡就要到手!"),shareURL,"http://h5.m.jd.com/active/carrace/sprites/icon.jpg"];
