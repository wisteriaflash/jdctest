...
function showRanking() {
    ...
    $("#prizelist").off().click(function () {
        location.href = "http://sale.jd.com/m/act/z2fbAiQ71nvYBZJW.html";
    });
...
function shareFunction(){
    s_oRequestManager.sendRealRequest("theCarRaceWeiXinShareOil", g_sid, " ", function (json) {
        ...
        var param = [encodeURIComponent("4666元加油卡就要到手，快来帮我加油！"),encodeURIComponent(content+"，荣威350豪送的4666元加油卡就要到手!"),shareURL,"http://h5.m.jd.com/active/carrace/sprites/icon.jpg"];
