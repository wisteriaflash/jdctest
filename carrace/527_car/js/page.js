            ...
            s_oRequestManager.sendRealRequest("theCarRaceGetCurrentRanking", "", " ", function (json) {
                ...
                if (s_oMain.initGameByServerResult != undefined)
                {
                    ...
                    if (s_oMain.initGameByServerResult.ranking >= 1)
                        ...
                        $("#ranking_rank").html("前" + Math.floor(s_oMain.initGameByServerResult.ranking * 100) + "%的选手");
                }
...
function getGap(currentMiles){
    ...
    var arr = [{miles:67510,award:100},{miles:87074,award:200},{miles:166522,award:1600},{miles:293756,award:4666},{miles:500457,award:null}];
...
function shareFunction(){
    s_oRequestManager.sendRealRequest("theCarRaceWeiXinShareOil", g_sid, " ", function (json) {
        ...
        var param = [encodeURIComponent("4666元加油卡就要到手，快来帮我加油！"),encodeURIComponent(content+"，东风雪铁龙 C4L豪送的4666元加油卡就要到手!"),shareURL,"http://h5.m.jd.com/active/carrace/sprites/icon.jpg"];
