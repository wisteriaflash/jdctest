...
define('./component/com_slide', ['zepto'], function($) {
    //vars
    var name = 'slide';
    var optStr = name+'Opt';
    var instanceStr = name+'-instance';
    //Slide class
    var Slide = function(item, options) {
        this.element = item;
        this._init(options);
    };
    ...
    Slide.prototype = {
        ...
        _init: function(options) {
            ...
            var mergeData = settings ? settings : $.fn.slide.defaults;
        ...
        _resizeSlide: function(){
            ...
            //style
            me.slideWidth = itemArr.eq(0).width();
            ...
            var len = settings.isLoop ? me.itemLen+listNum*2 : me.itemLen;
            listNode.css({
                width: perWidh * len
            });
            itemArr.css('width',me.slideWidth);
        },
        ...
        cssTranslateFun: function(pos, speed){
            var me = this;
            var item = me.element;
            var settings = me._getSettings(item);
            //
        ...
        slideChange: function(index){
            ...
            me.cssTranslateFun(pos, settings.speed);
            //reset
        ...
        init: function(options) {
            this.each(function() {
                ...
                if (!$this.data(instanceStr)) {
                    $this.data(instanceStr, new Slide($this, options));
                }
            });
        },
        instance: function() {
